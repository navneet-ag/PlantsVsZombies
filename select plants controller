...
//        Stage window=(Stage) ((Node)event.getSource()).getScene().getWindow();
    ...
    public void OkReleased(MouseEvent mouseEvent) throws IOException {
        ...
        ImageView PeaShooter=new ImageView("sample/PeashooterSeedPacket.png");
        PeaShooter.setFitWidth(53);
        PeaShooter.setFitHeight(62);
        PeaShooter.setLayoutX(1+97-2);
        PeaShooter.setLayoutY(-5-1);
        ImageView SunFlower=new ImageView();
        ImageView WallNut=new ImageView();
        ImageView PotatoMine=new ImageView();
...
//            }
//        });
        Group root2=new Group(tableparent);
