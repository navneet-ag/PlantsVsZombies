...
public class AthleteZombie extends Zombie{
    ...
    AthleteZombie(int x, int y, Group root2, Level L1)
    {
        Health=100;
        AddAthleteZombie(x,y,root2,L1);
        setX(x);
        setY(y);
    }
    private void AddAthleteZombie(int x, int y, Group root2, Level L1)
    {

        final ImageView SelectedZombie = new ImageView();
        Image Zombie = new Image("sample/athlete_zombie.gif");
